...
my_code_accuracy = np.array([33.489, 56.06700000000001, 73.549, 80.089, 85.32000000000001, 87.849, 90.977, 87.49, 88.252, 92.338])  # Replace with actual accuracies from your code
...
plt.title('Accuracy Comparison Contrast Baseline')
